...
public class PanelDesaprobados extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PanelDesaprobados frame = new PanelDesaprobados(p);
	 ...
	 * Create the frame.
	 */
	public PanelDesaprobados(Programa p) {
		...
		String columnas[]= {"LU DESAPROBADOS"};
		...
		Iterable<Integer> d1= p.desaprobados();
		int colu=0;
	...
	if(colu==0)
		m.insertRow(0, new Object [] {"NO HAY DESAPROBADOS"});
	}
